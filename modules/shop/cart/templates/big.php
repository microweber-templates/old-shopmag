                    ...
                    <table class="mw-ui-table mw-ui-table-basic">
                        ...
                        foreach ($data as $item) :
                            ...
                            <tr class="mw-cart-item mw-cart-item-<?php print $item['id'] ?>">
                                ...
                                <td><input type="number" min="1" class="mw-ui-field quantity" value="<?php print $item['qty'] ?>" onchange="mw.cart.qty('<?php print $item['id'] ?>', this.value)"/>
                                </td>
                                ...
                                <td class="text-center"><a data-tip="<?php _e("Remove"); ?>" class="mw-icon-close show-on-hover tip"
                                                           href="javascript:mw.cart.remove('<?php print $item['id'] ?>');"></a>
                                </td>
                ...
                <?php else: ?>
                    <style>
                        @media screen and (max-width: 480px) {
                            .order-summary-table-holder {
                                width: 100%;
                            }

                            .order-summary-table-holder td {
                                display: block;
                            }
                        }
                    </style>
                        ...
                        <div class="order-summary-table-holder">
                            ...
                            <table cellspacing="0" cellpadding="0" class="order-summary-table" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="cell-shipping-total"><span
                                                class="total_cost"><?php print currency_format($total + intval(mw()->user_manager->session_get('shipping_cost'))); ?></span>
                                    </td>
