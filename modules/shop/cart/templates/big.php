...
<div class="mw-cart mw-cart-big mw-cart-<?php print $params['id']?> <?php print  $template_css_prefix;  ?>">
  <div class="mw-cart-title mw-cart-<?php print $params['id']?>"> </div>
       ...
       ?>
          <tr class="mw-cart-item mw-cart-item-<?php print $item['id'] ?>">
            ...
            <td><?php if($p != false): ?>
              ...
              <?php endif; ?></td>
            <td class="mw-cart-table-product"><h3><?php print $item['title'] ?></h3>
  ...
  <hr>
  <a href="<?php print page_link($shop_page[0]['id']); ?>" class="mw-ui-btn pull-left">
